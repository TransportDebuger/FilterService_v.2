...
class IMetricsRegistry {
  ...
  */
  virtual std::shared_ptr<ICounter> RegisterCounter(std::string_view name,
  ...
  */
  virtual std::shared_ptr<IGauge> RegisterGauge(std::string_view name,
                                                std::string_view help) = 0;
  ...
  наблюдений.
  */
  virtual std::shared_ptr<IHistogram> RegisterHistogram(
