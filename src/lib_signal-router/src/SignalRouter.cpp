 ...
 * @version 1.0
 *
 * @note Класс реализован по шаблону Singleton, доступ через SignalRouter::instance().
 * @note Все публичные методы потокобезопасны.
 * @note Работает только на Linux (требует signalfd, epoll).
 *
 * @warning
...
SignalRouter::~SignalRouter() {}
  ...
  /**
   * @internal
 * @brief Приватный конструктор класса SignalRouter::Impl.
 *
